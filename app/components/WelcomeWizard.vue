      ...
      <div class="flex items-center justify-between w-full">
        ...
        <div class="flex gap-1.5 items-center">
          <div
            ...
            :class="i - 1 === step ? 'bg-indigo-400 w-4' : 'bg-gray-300 dark:bg-gray-600 w-2'"
          />
        </div>
      </div>
    </template>
      ...
      <div class="h-[480px] overflow-y-auto pr-1">
        ...
        <div v-if="step === 1" class="space-y-4">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-3 space-y-1">
              <div class="flex items-center gap-2">
                <UIcon name="i-heroicons-list-bullet" class="text-indigo-400" />
                <span class="text-sm font-medium">List & filter</span>
              </div>
              <p class="text-xs text-gray-500 dark:text-gray-400">View all entitlements. Filter by guild, user, SKU, or status. Sort by date or type.</p>
            </div>
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-3 space-y-1">
              <div class="flex items-center gap-2">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">Instantly grant any SKU to a guild or user for testing, without real payment.</p>
            </div>
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-3 space-y-1">
              <div class="flex items-center gap-2">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">Remove test entitlements individually or in bulk. Only test ones can be deleted — real subscriptions are read-only.</p>
            </div>
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-3 space-y-1">
              <div class="flex items-center gap-2">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">Total, active, test, and expired counts with a visual type breakdown.</p>
            </div>
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-3 space-y-1">
              <div class="flex items-center gap-2">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">Server names resolved automatically. Falls back to public widget if the bot isn't a member.</p>
            </div>
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-3 space-y-1">
              <div class="flex items-center gap-2">
                <UIcon name="i-heroicons-clipboard-document" class="text-gray-500 dark:text-gray-300" />
                <span class="text-sm font-medium">Copy IDs</span>
              </div>
              <p class="text-xs text-gray-500 dark:text-gray-400">Click any guild or user badge to copy the ID to clipboard instantly.</p>
            </div>
          </div>
        </div>
        ...
        <div v-if="step === 2" class="space-y-4">
          ...
          <div class="space-y-3">
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Click the app name in the header to switch between saved apps or add a new one.</p>
              </div>
            </div>
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Go to <strong>App switcher → Add another app</strong> to connect a second bot. Give it a name to tell them apart.</p>
              </div>
            </div>
            <div class="rounded-lg bg-gray-100 dark:bg-gray-800 p-4 flex items-start gap-3">
        ...
        <div v-if="step === 3" class="space-y-4">
          ...
          <div class="rounded-lg border border-green-500/30 bg-green-500/10 p-4 flex items-start gap-3">
            ...
            <div class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              <p><strong class="text-green-600 dark:text-green-300">Your bot token is never sent to any third-party server.</strong></p>
              <p>All saved apps' credentials are stored in your browser's <code class="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-1 rounded">localStorage</code> and only transit to <em>this local server</em>, which proxies requests directly to Discord's API.</p>
